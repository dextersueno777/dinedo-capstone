-- CreateEnum
CREATE TYPE "UserRole" AS ENUM ('CUSTOMER', 'ADMIN', 'KITCHEN', 'RIDER');
...
CREATE TABLE "BranchSettings" (
    ...
    "orderingOpenTime" TEXT NOT NULL DEFAULT '08:00',
    "orderingCloseTime" TEXT NOT NULL DEFAULT '18:00',
    "normalDeliveryKm" DECIMAL(8,2) NOT NULL DEFAULT 1.00,
